        ...
        <div className="p3 mx-auto mw-1024">
          <div className="mw-584">
            ...
            <p>
              ...
              { this.props.customLesson.title !== "Steno" ? <Link to={`${this.props.match.url}/custom?recommended=true&study=discover&newWords=1&seenWords=1&retainedWords=1&sortOrder=sortOff&startFromWord=1`.replace(/\/{2,}/g,'/')} onClick={this.props.stopLesson} className="dib ml2">Start custom lesson</Link> : null }
            </p>
