...
examples.	KP-PLS TP-PL"
                  ...
                  <div className="text-right">
                    <Link to='/lessons/custom?recommended=true&study=practice&newWords=1&seenWords=1&retainedWords=1&sortOrder=sortOff&startFromWord=1' className="link-button dib text-right" style={{lineHeight: 2}}>Start custom lesson</Link>
                  </div>
                </div>
              </div>
            </div>
