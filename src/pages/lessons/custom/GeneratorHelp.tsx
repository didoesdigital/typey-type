...
const GeneratorHelp = ({ hideHelp, containerId }: Props) => (
  ...
  >
    <div className="mw100 type-face--sans-serif">
      ...
      <RuleBlurb>
        <p>This rule looks for dictionary translations with exactly 1 space.</p>
        <p className="mb0">E.g. includes “is it”.</p>
        <p>E.g. excludes “in real life” and “world”.</p>
      </RuleBlurb>
      ...
      <RuleBlurb>
        ...
        <p>E.g. excludes “world” and “%”.</p>
      </RuleBlurb>

      <RuleHeading>“has numbers”</RuleHeading>
      <RuleBlurb>
        <p>This rule looks for dictionary translations with any digits.</p>
        <p className="mb0">
          E.g. includes “7-zip” and “100 Years of Solitude”.
        </p>
        <p>E.g. excludes “factor VII”, “seven”, and “%”.</p>
      </RuleBlurb>
      ...
      <RuleBlurb>
        ...
        <p>E.g. excludes “ill”.</p>
      </RuleBlurb>

      <RuleHeading>“has punctuation”</RuleHeading>
      <RuleBlurb>
        <p>This rule looks for any punctuation and symbols, including emoji.</p>
        {/* eslint-disable-next-line jsx-a11y/accessible-emoji */}
        <p className="mb0">
          E.g. includes “I'll”, “£”, “©”, “💯”, and{" "}
          <code>&#123;&amp;%&#125;</code>.
        </p>
        <p>E.g. excludes “ill”, “is it”, and “1”.</p>
      </RuleBlurb>

      <RuleHeading>“has a capital letter”</RuleHeading>
      <RuleBlurb>
        <p>This rule looks for any capital letter.</p>
        <p className="mb0">E.g. includes “A”, “iPhone”, and “HTML”.</p>
        <p>E.g. excludes “a”, “phone”, and “.html”.</p>
      </RuleBlurb>
      ...
      <RuleBlurb>
        ...
        <p>E.g. excludes “a”, “iPhone”, and “Harry”.</p>
      </RuleBlurb>
      ...
      <RuleBlurb>
        <p>This rule looks for entries with dropped unstressed vowels.</p>
        <p className="mb0">
      ...
      <RuleBlurb>
        <p>This rule looks for exactly two vowels in a row.</p>
        <p className="mb0">E.g. includes “look”.</p>
        <p>E.g. excludes “yaaaaaaay”.</p>
      </RuleBlurb>
      ...
      <RuleBlurb>
        ...
        <p>E.g. excludes “III”.</p>
      </RuleBlurb>

      <RuleHeading>“has double consonants”</RuleHeading>
      <RuleBlurb>
        <p>This rule looks for exactly two consonants” in a row.</p>
        <p className="mb0">E.g. includes “Harry”.</p>
        <p>E.g. excludes “best”.</p>
      </RuleBlurb>
