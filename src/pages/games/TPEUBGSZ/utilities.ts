...
const isSuffix = (affixType: "suffixes" | "prefixes") =>
  affixType === "suffixes";
...
const addSomeAffixes = (
  madeUpWordParts: string[],
  madeUpAffixParts: string[],
  affixType: "suffixes" | "prefixes",
  count: number,
  level: number,
...
export const makeUpAWordAndHint = (level: number, numberOfMetWords: number) => {
  const madeUpWordParts: string[] = [];
  const madeUpAffixParts: string[] = [];
  addSomeAffixes(
    madeUpWordParts,
    madeUpAffixParts,
    "prefixes",
