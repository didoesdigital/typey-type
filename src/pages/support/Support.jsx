        ...
        <div className="p3 mx-auto mw-1024 type-face--sans-serif">
          <div className="mw-568">
            <p className="mt3">
              ...
              faster. You can learn briefs and improve your stenographic speed
              and accuracy. Lessons evolve as you progress. They have tight
            ...
            <p>
              ...
              <strong>stenography</strong>. Using a stenotype machine (or a
              fancy keyboard) and special software, you can type over 100 or
              even 200 words per minute. You press keys together on a stenotype
              machine like playing a piano chord. The software translates the
              combination into meaningful words according to their phonetic
              sounds. Plover is the world’s first free, open-source stenography
              program. You can learn more about Plover from the{" "}
              <OutboundLink
            ...
            <DescriptionList>
              ...
              <DescriptionDetails>
                ...
                pressed together to produce a specific word or phrase. Strictly,
                a brief or abbreviation is a shortened outline form with fewer
              ...
              <DescriptionDetails>
                Misstrokes are extra entries that use similar keys to produce
                the word you meant to write. If you regularly mistype a word,
                you might add a misstroke entry for the keys you are incorrectly
                pressing so that your dictionaries effectively autocorrects your
                mistakes. For example, the misstroke{" "}
                <span className="steno-stroke">SPHAOEU</span> to write “supply”
                is missing the left-hand <span className="steno-stroke">R</span>{" "}
            ...
            <p>
              ...
              <Link to="/progress">your progress</Link>. That’s when it saves
              all the new words you’ve successfully typed. If you leave a lesson
              without stopping it or finishing it, you’ll lose that lesson’s
              progress. Typey&nbsp;Type saves your brief progress in your
              browser’s local storage. You’ll lose your progress if you clear
              your browsing data (history, cookies, and cache). If you share
              this device with other people or use Typey&nbsp;Type across
              several devices and browsers, you should save your progress
            ...
            <p>
              <Link to="/lessons/custom">Typey&nbsp;Type custom lessons</Link>{" "}
            ...
            <p>
              ...
              create a brief to press <kbd>Tab</kbd> and <kbd>Space</kbd> for
              you, such as{" "}
            ...
            <p>
              There are some keyboard shortcuts available when you finish a
              lesson that make use of the browser’s built in{" "}
              <OutboundLink
            ...
            <p>
              To jump to the <strong className="fw7">next lesson</strong>, use
              the <code>accesskey</code> shortcut plus the <kbd>o</kbd> key. You
              can create a steno brief for the shortcut like this:
            </p>
            <ul>
              <li>
                For macOS:{" "}
                <code>{dictionaryEntryForMacNextLessonAccessKey}</code>
              </li>
              <li>
                For everything else:{" "}
            ...
            <DescriptionList>
              ...
              <DescriptionDetails>
                ...
                phrase for checking if you typed it correctly. Steno software
                can insert spaces before or after words, depending on the
                specific software and its settings. For example, Plover inserts
                spaces before words by default, and has a setting to insert
                spaces after words. Plover also provides extra spacing and
                capitalisation modes that can be set on the fly. This might
                suppress spaces or insert other punctuation (like dashes). A
                QWERTYist may feel more comfortable drilling words without any
                spaces, or sentences with spaces as the end.
              </DescriptionDetails>
              <DescriptionTerm>Seen words</DescriptionTerm>
              <DescriptionDetails>
                Typey&nbsp;Type tracks words you’ve "seen" or "met". Each time
                you successfully type a new word, that’s logged as a successful
                meeting.
              </DescriptionDetails>
              <DescriptionTerm>Words per minute (WPM)</DescriptionTerm>
              <DescriptionDetails>
                To track your typing speed, Typey&nbsp;Type displays the number
                of words you’ve typed per minute using the unit “words per
                minute (WPM)”. A word is considered to be 5 letters long on
                average. This means you might type many short words and have a
                higher WPM score.
              </DescriptionDetails>
              ...
              <DescriptionDetails>
                ...
                stroking out long, phonetic forms of words so you can memorise
                and rehearse the best brief for every word. Choose a lesson with
                the majority of words you’re interested in nailing first like
                the top 1000 words.
              </DescriptionDetails>
              <DescriptionTerm>Drill</DescriptionTerm>
              <DescriptionDetails>
                The third type of study session is about building up your muscle
                memory and testing your skills. Write as fast and furiously as
                you can and aim for a high WPM score. Pick specific drills that
                focus on a certain kind of brief or many similar words so you
            ...
            <p>
              Flashcards are designed for mobile devices so you can memorise
              steno briefs on the go. When you’re unable to recall a brief, tap
              “Hard” to say it was hard to remember. When you can recall a brief
              without hesitation, tap “Easy”. While studying flashcards, imagine
              which fingers and the shape of the outline you’d use to stroke a
              word.
            </p>
            <p>
              If it’s been a while since you’ve studied, the “threshold” will be
              set quite high. You’ll see flashcards you’ve studied that are
              below the threshold. That is, if the threshold is 12, you’ll see
              flashcards for words you’ve marked “Easy” less than 12 times. If
              you’ve marked a word as “Easy” 15 times, it won’t shown again
            ...
            <p>
              Typey&nbsp;Type does not yet officially support offline use
              through the website. Until then, it’s technically possible to make
              it work offline by running the code yourself. You can follow the
              steps from the{" "}
              <OutboundLink
            ...
            <p>
              ...
              and use its “arpeggiate” setting. This setting lets you use a
              QWERTY keyboard to write stenography. The trick is that you press
              each key separately and then press space bar to send the stroke.
              Usually a stenographer will press all keys together and release
              them together. Most QWERTY keyboards, however, are non-NKRO (N-key
              roll over), meaning only the first 6 keys held together will be
              noticed; later keys are ignored. Arpeggiate will let you explore
              steno, but is unrealistic.
            </p>

            <h4 id="requirements-for-steno">
              What do you need to learn steno?
            </h4>
            <p>
              You need a{" "}
              <OutboundLink
            ...
            <p>
              ...
              might take 6–18&nbsp;months. For live dictation at 200WPM, it
              might take you 2&nbsp;or&nbsp;more years. If you are learning
              stenography for ergonomic reasons and have injuries to manage, it
              could take longer.
            </p>
            ...
            <p>
              ...
              aggressively. For one day that might not seem like much, but after
              a month that’s about 500 new words.
            </p>
            ...
            <p>
              Using a metronome might help you improve your rhythm for each
              stroke in finger drills. By drilling difficult transitions between
              pairs of strokes that slow you down or cause you hesitation using
              a metronome, you may improve your slowest pairs.
            </p>
            ...
            <ul>
              ...
              <li>
                ...
                <Link to="/lessons#tech">tech</Link> lessons, or have
                stenographic or linguistic significance, such as{" "}
            ...
            <p>
              ...
              stenotype with more keys. That means palantype can have fewer
              theory conflicts and be easier to learn. Meanwhile, stenography is
              more popular and more ergonomic.{" "}
              <OutboundLink
            ...
            <p>
              Here’s some of the code used by Typey&nbsp;Type available on
              GitHub:
            </p>
            <ul>
              <li>
                ...
                . This contains the application code that makes Typey&nbsp;Type
                do useful things.
              </li>
              <li>
                <OutboundLink
                ...
                lesson data used by Typey&nbsp;Type. The scripts are not
                included.
              </li>
              <li>
                <OutboundLink
              ...
              <li>
                ...
                . This project contains scripts used to manually convert SVG
                steno diagrams into React syntax to be used by the main
                Typey&nbsp;Type repo.
              </li>
            </ul>
