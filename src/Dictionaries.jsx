...
const Dictionaries = ({match, dictionaryIndex, setDictionaryIndex, globalLookupDictionaryLoaded, globalLookupDictionary, updateGlobalLookupDictionary, ...dictionaryProps}) => {
  return(
    <div>
      <Switch>
