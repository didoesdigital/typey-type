          ...
          <div className="flex flex-wrap justify-between">
            <div>
              <div className="mw-584">
                ...
                <p>
                  To help Typey&nbsp;Type grow even faster, add your custom
                  lessons to the{" "}
                ...
                <p>
                  <Link
                    to={`${this.props.match.url}/custom/setup`.replace(
                      /\/{2,}/g,
                      "/"
                    )}
                  ...
                  {this.props.customLesson.title !== "Steno" ? (
                    <Link
                      to={`${this.props.match.url}/custom?study=discover&newWords=1&seenWords=1&retainedWords=1&sortOrder=sortOff&startFromWord=1`.replace(
                        /\/{2,}/g,
                        "/"
                      )}
