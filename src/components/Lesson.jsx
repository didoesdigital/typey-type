                      ...
                      <div>
                        ...
                        <div className="mx-auto mw-1920 p3">
                          ...
                          <div role="article" className="lesson-canvas panel mx-auto mw-1440 p2 mb3 flex">
                            {revisionModeButton}
                            <div className={`mx-auto mw100 mt10 min-width70 material-typed-text-and-hint flex-grow${this.props.userSettings.upcomingWordsLayout === "multiline" ? ' mw-696 mx-auto' : ''}`}>
                              <Material
                                actualText={this.props.actualText}
