        ...
        <div className="p3 mx-auto mw-1024">
          ...
          <div>
            <div className="mw-584">
              ...
              <p><Link to="/dictionaries/typey-type/typey-type/">Typey&nbsp;Type’s dictionary</Link> removes many misstrokes and mimics the <strong>Plover version 4 dictionary</strong>.</p>
              <p>You can use Plover’s dictionary or you can use use Di’s dictionaries that power Typey Type’s stroke suggestions from <GoogleAnalytics.OutboundLink
              ...
              <h4>Stroke hints</h4>
              <p>Typey&nbsp;Type’s stroke hints look for the shortest briefs with penalties for briefs using multiple strokes, the star (<code>*</code>) key, and non-standard prefix or suffix strokes.</p>
