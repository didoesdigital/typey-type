      ...
      <div className="mb1 nt1">
        <div className="expected">
          ...
          <div className="material">
            <pre className="material-pre relative"><div className={"dib current-and-upcoming-phrases" + blur}><strong className="current-phrase-material" tabIndex="0">{spaceAfterOutput}<span className="matched steno-material">{matched}</span><span className="steno-material">{unmatched}</span>{spaceBeforeOutput}</strong><span className={nextUpcomingClasses}>{nextMaterial}{spaceAfterOutput}</span><span className="de-emphasized upcoming-phrases">{spaceBeforeOutput}{restUpcomingMaterial}{spaceAfterOutput}</span></div><span className="dib de-emphasized completed-phrases">&#8203;{this.props.completedPhrases}</span></pre>
          </div>
        </div>
      </div>
    );
