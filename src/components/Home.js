            ...
            <div className="p3 mx-auto mw-1024">
              <div className="mw-584 ml-auto text-right">
                ...
                <p>
                  ...
                  lesson. Before you start typing, customise “your settings”.
                  Set spaces match your steno settings: spaces before words,
                  spaces after words, or ignore spaces&nbsp;completely.
                </p>
                <Link
            ...
            <div className="p3 mx-auto mw-1024">
              <div className="mw-584">
                ...
                <p>
                  ...
                  concentrating on accuracy and forming good habits around how
                  you stroke word parts.
                </p>
                <Link
                  to="/lessons/fundamentals/introduction/"
                  className="link-button dib"
            ...
            <div className="p3 mx-auto mw-1024">
              <div className="mw-584 ml-auto text-right">
                ...
                <p>
                  ...
                  writing out the long forms of words. This helps you memorise
                  the best brief for every word.{" "}
                </p>
                <Link
          ...
          <div className="bg-info landing-page-section">
            <div className="p3 mx-auto mw-1024">
              <div className="mw-584">
                ...
                <p>
                  Regularly drill common words to build up your muscle memory
                  and test your skills. Write as fast and furiously as you can,
                  aiming for a high speed score. Pick specific drills that focus
          ...
          <div className="bg-white landing-page-section">
            <div className="p3 mx-auto mw-1024">
              <div className="mw-584 ml-auto text-right">
                ...
                <p>
                  Finally, practise longer lessons to mimic real usage as
          ...
          <div className="bg-white landing-page-section">
            <div className="p3 mx-auto mw-1024">
              <div className="mw-584 ml-auto text-right">
                <h3>Rest</h3>
                <p>
                  Rest your hands and your mind with a 5-minute break timer.
                </p>
                <Link
                  to="/break/"
                  className="link-button dib"
          ...
          <div className="bg-info landing-page-section">
            <div className="p3 mx-auto mw-1024">
              <div className="mw-584">
                <h3>Your settings</h3>
                <p>
                  Choose the right settings for you. Try other steno layouts,
                  blur words, or have words spoken to you.
                </p>
                <Link
                  to="/lessons/fundamentals/introduction/"
                  className="link-button dib"
          ...
          <div className="bg-white landing-page-section">
            <div className="p3 mx-auto mw-1024">
              <div className="mw-584 ml-auto text-right">
                <h3>Games</h3>
                <p>
                  Play games to mix it up, have fun, and increase your speed.
                </p>
                <Link
                  to="/games/"
                  className="link-button dib"
