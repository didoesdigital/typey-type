    ...
    return (
      <svg id={svgDiagramID} width={diagramWidth} viewBox="0 0 258 99" xmlns="http://www.w3.org/2000/svg" aria-hidden={hidden} className={this.props.classes}>
        <g id={"stenoboard-" + this.props.brief } fill="none" fillRule="evenodd" stroke="none" strokeWidth="1">
          ...
          <path id="eRightLowercaseLetter" d="M181.656 53.504c0 .47-.021.843-.064 1.12h-5.568c.117.597.355 1.07.712 1.416.357.347.819.52 1.384.52.715 0 1.317-.267 1.808-.8l1.104 1.168c-.768.843-1.744 1.264-2.928 1.264-1.205 0-2.157-.39-2.856-1.168-.699-.779-1.048-1.819-1.048-3.12 0-1.323.352-2.365 1.056-3.128.704-.763 1.653-1.144 2.848-1.144 1.045 0 1.899.328 2.56.984.661.656.992 1.619.992 2.888zm-5.648-.448h3.84c-.053-.597-.243-1.048-.568-1.352a1.661 1.661 0 00-1.176-.456c-.587 0-1.059.16-1.416.48-.357.32-.584.763-.68 1.328z" fill={this.props.eRightLowercase ? eRightLowercaseLetterOnColor : eRightLowercaseLetterOffColor}/>
          <path id="iRightLowercaseLetter" d="M166.992 83.688c-.299 0-.555-.107-.768-.32a1.066 1.066 0 01-.32-.784c0-.31.107-.568.32-.776.213-.208.47-.312.768-.312.31 0 .57.104.784.312.213.208.32.467.32.776 0 .31-.107.57-.32.784-.213.213-.475.32-.784.32zm.928 7.696h2.256V93h-6.352v-1.616h2.256V86.44h-2.256v-1.616h4.096v6.56z" fill={this.props.iRightLowercase ? iRightLowercaseLetterOnColor : iRightLowercaseLetterOffColor}/>
          ...
          <path id="leftCapitalRLetter" d="M74.752 85.192a3.48 3.48 0 01-.584 1.968c-.39.587-.952 1.003-1.688 1.248L74.736 93h-2.112l-2.176-4.384H69.12V93h-1.904V81.8h3.872c.661 0 1.237.093 1.728.28.49.187.872.443 1.144.768.272.325.472.683.6 1.072.128.39.192.813.192 1.272zm-5.632-1.6v3.232h2c.597 0 1.027-.152 1.288-.456.261-.304.392-.69.392-1.16 0-.448-.128-.83-.384-1.144-.256-.315-.688-.472-1.296-.472h-2z" fill={this.props.leftCapitalR ? leftCapitalRLetterOnColor : leftCapitalRLetterOffColor}/>
          <path id="leftCapitalNLetter" d="M56.216 58V46.8h1.808l3.488 6.912c.192.33.325.587.4.768a20.287 20.287 0 01-.032-.768V46.8h1.76V58h-1.728l-3.552-6.944a10.95 10.95 0 01-.416-.768c.032.16.048.416.048.768V58h-1.776z" fill={this.props.leftCapitalN ? leftCapitalNLetterOnColor : leftCapitalNLetterOffColor}/>
          ...
          <path id="leftCapitalCLetter" d="M31.12 93.176a4.17 4.17 0 01-1.704-.336 3.721 3.721 0 01-1.264-.888 4.812 4.812 0 01-.84-1.312 6.827 6.827 0 01-.48-1.568 9.514 9.514 0 01-.144-1.672c0-.704.083-1.384.248-2.04.165-.656.419-1.27.76-1.84.341-.57.805-1.03 1.392-1.376.587-.347 1.264-.52 2.032-.52.875 0 1.605.224 2.192.672a3.9 3.9 0 011.28 1.664l-1.696.816c-.235-.448-.488-.784-.76-1.008-.272-.224-.61-.336-1.016-.336-.576 0-1.056.213-1.44.64-.384.427-.65.925-.8 1.496a7.214 7.214 0 00-.224 1.832c0 1.056.213 1.981.64 2.776.427.795 1.035 1.192 1.824 1.192.747 0 1.344-.48 1.792-1.44l1.728.656c-.704 1.728-1.877 2.592-3.52 2.592z" fill={this.props.leftCapitalC ? leftCapitalCLetterOnColor : leftCapitalCLetterOffColor}/>
          <path id="leftCapitalSLetter" d="M11.056 93.192a4.086 4.086 0 01-2.448-.784 4.18 4.18 0 01-1.536-2.096l1.728-.64c.245.523.584.941 1.016 1.256a2.33 2.33 0 001.4.472c.49 0 .885-.128 1.184-.384.299-.256.448-.624.448-1.104 0-.405-.203-.765-.608-1.08-.405-.315-.97-.632-1.696-.952a16.36 16.36 0 01-1.104-.528 7.093 7.093 0 01-.936-.624 2.563 2.563 0 01-.776-.944 2.82 2.82 0 01-.256-1.216c0-.832.317-1.533.952-2.104.635-.57 1.47-.856 2.504-.856.821 0 1.539.224 2.152.672.613.448 1.021 1.019 1.224 1.712l-1.712.576c-.384-.779-.976-1.168-1.776-1.168-.416 0-.757.107-1.024.32-.267.213-.4.507-.4.88 0 .085.01.168.032.248.021.08.059.155.112.224.053.07.104.133.152.192s.123.123.224.192c.101.07.187.125.256.168a6.518 6.518 0 00.632.32c.075.032.197.088.368.168.17.08.293.136.368.168.448.203.821.392 1.12.568.299.176.63.408.992.696.363.288.64.63.832 1.024.192.395.288.827.288 1.296 0 1.024-.36 1.835-1.08 2.432-.72.597-1.597.896-2.632.896z" fill={this.props.leftCapitalS ? leftCapitalSLetterOnColor : leftCapitalSLetterOffColor}/>
