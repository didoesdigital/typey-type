...
class JapaneseStenoDiagram extends Component {
  render() {
    ...
    let theカSymbolOffColor = '#E9D9F2';
    let theRightKagikakkoSymbolOnColor = '#FFFFFF';
    let theRightKagikakkoSymbolOffColor = '#E9D9F2';
    let theRightっSymbolOnColor = '#FFFFFF';
    let theRightっSymbolOffColor = '#E9D9F2';
    let theRightおSymbolOnColor = '#FFFFFF';
    let theRightおSymbolOffColor = '#E9D9F2';
    let theRight1SymbolOnColor = '#FFFFFF';
    let theRight1SymbolOffColor = '#E9D9F2';
    let theRightうSymbolOnColor = '#FFFFFF';
    let theRightうSymbolOffColor = '#E9D9F2';
    let theRightいSymbolOnColor = '#FFFFFF';
    let theRightいSymbolOffColor = '#E9D9F2';
    let theRight2SymbolOnColor = '#FFFFFF';
    let theRight2SymbolOffColor = '#E9D9F2';
    let theRightさSymbolOnColor = '#FFFFFF';
    let theRightさSymbolOffColor = '#E9D9F2';
    let theRightかSymbolOnColor = '#FFFFFF';
    let theRightかSymbolOffColor = '#E9D9F2';
    let theRight3SymbolOnColor = '#FFFFFF';
    let theRight3SymbolOffColor = '#E9D9F2';
    let theRightなSymbolOnColor = '#FFFFFF';
    let theRightなSymbolOffColor = '#E9D9F2';
    let theRightたSymbolOnColor = '#FFFFFF';
    let theRightたSymbolOffColor = '#E9D9F2';
    let theRight4SymbolOnColor = '#FFFFFF';
    let theRight4SymbolOffColor = '#E9D9F2';
    let theStarSymbolOnColor = '#FFFFFF';
    let theStarSymbolOffColor = '#E9D9F2';
    let theLeftっSymbolOnColor = '#FFFFFF';
    let theLeftっSymbolOffColor = '#E9D9F2';
    let theLeftおSymbolOnColor = '#FFFFFF';
    let theLeftおSymbolOffColor = '#E9D9F2';
    let theLeft1SymbolOnColor = '#FFFFFF';
    let theLeft1SymbolOffColor = '#E9D9F2';
    let theLeftうSymbolOnColor = '#FFFFFF';
    let theLeftうSymbolOffColor = '#E9D9F2';
    let theLeftいSymbolOnColor = '#FFFFFF';
    let theLeftいSymbolOffColor = '#E9D9F2';
    let theLeft2SymbolOnColor = '#FFFFFF';
    let theLeft2SymbolOffColor = '#E9D9F2';
    let theLeftさSymbolOnColor = '#FFFFFF';
    let theLeftさSymbolOffColor = '#E9D9F2';
    let theLeftかSymbolOnColor = '#FFFFFF';
    let theLeftかSymbolOffColor = '#E9D9F2';
    let theLeft3SymbolOnColor = '#FFFFFF';
    let theLeft3SymbolOffColor = '#E9D9F2';
    let theLeftなSymbolOnColor = '#FFFFFF';
    let theLeftなSymbolOffColor = '#E9D9F2';
    let theLeftたSymbolOnColor = '#FFFFFF';
    let theLeftたSymbolOffColor = '#E9D9F2';
    let theLeft4SymbolOnColor = '#FFFFFF';
    let theLeft4SymbolOffColor = '#E9D9F2';
    let theLeftKagikakkoSymbolOnColor = '#FFFFFF';
    let theLeftKagikakkoSymbolOffColor = '#E9D9F2';
    let the漢SymbolOnColor = '#FFFFFF';
    let the漢SymbolOffColor = '#E9D9F2';

    return (
      <svg width="202" viewBox="0 0 202 108" xmlns="http://www.w3.org/2000/svg" aria-hidden={hidden}>
        <g id={"stenoboard-" + this.props.brief } fill="none" fillRule="evenodd" stroke="none" strokeWidth="1">
          <g fillRule="nonzero" transform="translate(1 2)">
            ...
            <path id="theLeft2Symbol" d="M28.296 13.192c1.461-1.141 2.584-2.099 3.368-2.872.784-.773 1.31-1.416 1.576-1.928a3.42 3.42 0 0 0 .4-1.6c0-1.184-.635-1.776-1.904-1.776-.896 0-1.915.368-3.056 1.104l-.592-1.792a6.585 6.585 0 0 1 1.864-.856 7.45 7.45 0 0 1 2.104-.312c1.248 0 2.21.301 2.888.904.677.603 1.016 1.437 1.016 2.504 0 1.003-.317 1.968-.952 2.896-.635.928-1.875 2.16-3.72 3.696v.032h4.688V15h-7.68v-1.808z" fill={this.props.theLeft2Symbol ? theLeft2SymbolOnColor : theLeft2SymbolOffColor}/>
            <path id="theLeftさSymbol" d="M55.744 63.6l.016-.016c-.373-.757-.672-1.621-.896-2.592a281.62 281.62 0 0 1-7.312.096V59.28c2.315 0 4.645-.032 6.992-.096-.085-.65-.144-1.29-.176-1.92l2.032-.128c.032.768.085 1.43.16 1.984 1.707-.064 3.003-.117 3.888-.16l.064 1.808c-.8.043-2.01.096-3.632.16.33 1.333.95 2.71 1.856 4.128l-1.936.976c-1.152-.768-2.39-1.152-3.712-1.152-.81 0-1.44.163-1.888.488a1.547 1.547 0 0 0-.672 1.32c0 .736.33 1.304.992 1.704.661.4 1.648.6 2.96.6 1.173 0 2.47-.144 3.888-.432l.336 1.808a20.262 20.262 0 0 1-4.224.432c-2.048 0-3.573-.384-4.576-1.152-1.003-.768-1.504-1.787-1.504-3.056 0-1.067.405-1.92 1.216-2.56.81-.64 1.936-.96 3.376-.96.939 0 1.856.176 2.752.528z" fill={this.props.theLeftさSymbol ? theLeftさSymbolOnColor : theLeftさSymbolOffColor}/>
            <path id="theLeftかSymbol" d="M50.672 41l.56-1.84c1.13.405 1.93.608 2.4.608.181 0 .347-.133.496-.4.15-.267.28-.739.392-1.416.112-.677.168-1.512.168-2.504 0-1.28-.056-2.027-.168-2.24-.112-.213-.515-.32-1.208-.32h-1.664a60.228 60.228 0 0 1-2.88 8.992l-1.808-.64a64.511 64.511 0 0 0 2.656-8.352h-2.448V31.08h