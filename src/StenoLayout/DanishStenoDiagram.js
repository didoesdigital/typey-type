      ...
      <svg viewBox="0 0 215 101" width="140" xmlns="http://www.w3.org/2000/svg" aria-hidden={hidden}>
        <g id={"stenoboard-" + this.props.brief } transform="translate(1 1)" fill="none" fillRule="evenodd">
          ...
          <g id="Outlines" transform="translate(5 2)" fill="#FFF">
            <path d="M202.568 51v1.44l-5.104 7.952h5.088V62.2H195v-1.44l5.072-7.968h-4.72V51z" id="DLower" fill={this.props.leftDLower ? onTextColor : offTextColor}/>
            ...
            <path d="M157.416 62.584c-3.04 0-4.416-2.864-4.416-5.792 0-2.8 1.456-5.792 4.416-5.792 1.904 0 2.816 1.104 3.456 2.256l-1.68.96c-.4-.752-.928-1.408-1.776-1.408-1.792 0-2.432 2.208-2.432 3.984 0 2.032.768 3.984 2.432 3.984 1.184 0 1.776-.896 1.776-2.08v-.24h-1.952v-1.792h3.904v1.552c0 2.832-1.616 4.368-3.728 4.368z" id="K" fill={this.props.leftK ? onTextColor : offTextColor}/>
            <path d="M153 34.2V23h1.904v9.376h5.168V34.2z" id="L" fill={this.props.rightL ? onTextColor : offTextColor}/>
            <path d="M132 62.2V51h3.776c2.72 0 3.584 1.488 3.584 2.992 0 .992-.464 1.856-1.456 2.304 1.248.416 1.84 1.504 1.84 2.624 0 1.568-.944 3.28-3.728 3.28H132zm1.904-6.672h1.616c1.312 0 1.936-.56 1.936-1.408 0-.656-.272-1.36-1.632-1.36h-1.92v2.768zm0 4.912h2.24c1.328 0 1.696-.8 1.696-1.504 0-.832-.4-1.664-2.16-1.664h-1.776v3.168z" id="E" fill={this.props.leftE ? onTextColor : offTextColor}/>
            ...
            <path d="M125.928 90.5919996c-2.016 0-3.776-1.136-3.776-4.464v-6.928h1.888v6.928c0 2.064.8 2.656 1.888 2.656 1.072 0 1.888-.592 1.888-2.656v-6.928h1.904v6.928c0 3.28-1.744 4.464-3.792 4.464z" id="Å" fill={this.props.rightÅ ? onTextColor : offTextColor}/>
            <path d="M101.216 90.3999996v-11.2h7.184v1.808h-5.28v2.704h3.44v1.808h-3.44v3.072h5.616v1.808z" id="Æ" fill={this.props.rightÆ ? onTextColor : offTextColor}/>
            <path d="M89.52 46.6239996l-1.392-.976 1.008-1.456.832-.672-1.088.256H87.2v-1.728h1.68l1.088.256-.832-.672-1.008-1.456 1.392-.976 1.184 1.664.224.976.224-.976 1.184-1.664 1.392.976-1.008 1.456-.832.672 1.088-.256h1.696v1.728h-1.696l-1.088-.256.832.672 1.008 1.456-1.392.976-1.184-1.664-.224-.976-.224.976z" id="O" fill={this.props.leftO ? onTextColor : offTextColor}/>
            <path d="M76.928 90.5919996c-3.008 0-4.24-2.784-4.24-5.792s1.232-5.792 4.24-5.792 4.256 2.784 4.256 5.792-1.248 5.792-4.256 5.792zm0-1.808c1.584 0 2.272-1.984 2.272-3.984 0-2.128-.672-3.984-2.272-3.984-1.6 0-2.272 1.968-2.272 3.984 0 2.112.672 3.984 2.272 3.984z" id="A" fill={this.props.leftA ? onTextColor : offTextColor}/>
            <path d="M58.44 90.3999996l-.736-2.464h-3.552l-.736 2.464h-2.048l3.664-11.2h1.792l3.664 11.2H58.44zm-3.776-4.192h2.528l-.992-3.328c-.08-.256-.208-.832-.272-1.248-.08.416-.192.992-.272 1.248l-.992 3.328z" id="*" fill={this.props.star ? onTextColor : offTextColor}/>
