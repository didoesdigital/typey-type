...
function getRecommendedNextLesson(
  ...
  if (
    recommendedStudySession[recommendedStudySessionIndex] === "practice" &&
    numberOfWordsMemorised < 2
  ) {
    ...
    switch (practiceChoice) {
      ...
      case "practiceLessons": {
        const recommendedPracticeLesson = courses.practiceCourse.find(
          (recommendable) => {
            ...
            if (typeof entryInLessonsProgress === "undefined") {
              ...
              if (
                typeof entryInLessonsProgress[seenOrMemorisedChoice] !==
                "undefined"
              ) {
                if (seenOrMemorisedChoice === "numberOfWordsMemorised") {
                  ...
                  if (
                    entryInLessonsProgress[seenOrMemorisedChoice] >=
                    0.6 * recommendable.target
                  ) {
                    return false;
                  } else {
                    return true;
        ...
        const recommendedPracticeLessonInIndex = lessonIndex.find(
          (recommended) => {
            return (
              ...
              (recommendedPracticeLesson?.path ?? "")
            );
          }
        );
        ...
        if (typeof recommendedPracticeLessonInIndex !== "undefined") {
          if (
            typeof recommendedPracticeLessonInIndex.wordCount !== "undefined"
          ) {
        ...
        if (typeof recommendedPracticeLesson !== "undefined") {
          ...
          recommendedNextLesson.repetitions = 1;
          recommendedNextLesson.linkTitle =
            recommendedPracticeLesson.lessonTitle;
          recommendedNextLesson.linkText =
            "Practice " + recommendedPracticeLesson.lessonTitle;
          recommendedNextLesson.link =
            recommendedPracticeLesson.path.replace(/lesson.txt$/, "") +
            practiceParams;
        }
      ...
      default:
        ...
        recommendedNextLesson.linkText = "Practice your words";
        recommendedNextLesson.link =
          "/lessons/progress/?recommended=true&" + PARAMS.practiceParams;
        recommendedNextLesson.studyType = "practice";
        recommendedNextLesson.repetitions = 1;
        break;
    }
  ...
  if (
    recommendedStudySession[recommendedStudySessionIndex] === "drill" &&
    numberOfWordsMemorised < 2
  ) {
    recommendedStudySessionIndex = recommendedStudySessionIndex + 1;
  }
      ...
      case "drillLessons": {
        const recommendedDrillLesson = courses.drillCourse.find(
          (recommendable) => {
            ...
            if (
              (entryInLessonsProgress["numberOfWordsMemorised"] || 0) >=
            ...
            if ((entryInLessonsProgress["numberOfWordsMemorised"] || 0) < 15) {
              return false;
            }
        ...
        if (typeof recommendedDrillLesson !== "undefined") {
          ...
          recommendedNextLesson.linkText =
            ...
            " words from " +
            recommendedDrillLesson.lessonTitle +
            " with " +
            recommendedNextLesson.repetitions +
            " repetitions";
          recommendedNextLesson.link =
            recommendedDrillLesson.path.replace(/lesson.txt$/, "") +
            "?recommended=true&" +
            PARAMS.drillParams;
        } else {
          recommendedNextLesson.studyType = "drill";
  ...
  if (
    recommendedStudySession[recommendedStudySessionIndex] === "revise" &&
    numberOfWordsSeen < 15
  ) {
    recommendedStudySessionIndex = recommendedStudySessionIndex + 1;
  }
      ...
      case "reviseLessons": {
        ...
        const recommendedRevisionLesson = courses.revisionCourse.find(
          (recommendable) => {
            ...
            if (
              entryInLessonsProgress["numberOfWordsSeen"] >=
              recommendable["target"]
            ) {
              return false;
            }
            ...
            if (entryInLessonsProgress["numberOfWordsSeen"] < 15) {
              return false;
            }
        ...
        if (typeof recommendedRevisionLesson !== "undefined") {
          ...
          recommendedNextLesson.repetitions = 3;
          recommendedNextLesson.linkTitle =
            recommendedRevisionLesson.lessonTitle;
          recommendedNextLesson.linkText =
            "Revise 50 words from " +
            recommendedRevisionLesson.lessonTitle +
            " with 3 repetitions";
          recommendedNextLesson.link =
            recommendedRevisionLesson.path.replace(/lesson.txt$/, "") +
            "?recommended=true&" +
            PARAMS.reviseParams;
        } else {
          recommendedNextLesson.studyType = "revise";
  ...
  if (recommendedStudySession[recommendedStudySessionIndex] === "discover") {
    ...
    const recommendedDiscoverLesson = courses.discoverCourse.find(
      (recommendable) => {
        ...
        if (
          (entryInLessonsProgress["numberOfWordsSeen"] || 0) +
            (entryInLessonsProgress["numberOfWordsMemorised"] || 0) >=
          recommendable["target"]
        ) {
          return false;
    ...
    if (
      lessonsProgress[recommendedDiscoverLessonPath] &&
      lessonsProgress[recommendedDiscoverLessonPath].numberOfWordsToDiscover
    ) {
      wordsLeftToDiscover =
        lessonsProgress[recommendedDiscoverLessonPath].numberOfWordsToDiscover;
    }
    ...
    if (
      recommendedDiscoverLessonPath.includes("briefs") ||
      recommendedDiscoverLessonPath.includes("punctuation") ||
      recommendedDiscoverLessonPath.includes("longest")
    ) {
      limitNumberOfWords = Math.min(5, wordCount, wordsLeftToDiscover);
      discoverParams = discoverParams.replace(
        "limitNumberOfWords=15",
        "limitNumberOfWords=" + limitNumberOfWords.toString()
      );
    }
    ...
    if (typeof recommendedDiscoverLesson !== "undefined") {
      ...
      recommendedNextLesson.linkText =
        ...
        limitNumberOfWords +
        " words from " +
        recommendedDiscoverLesson.lessonTitle +
        " with 5 repetitions";
      recommendedNextLesson.link =
        recommendedDiscoverLesson.path.replace(/lesson.txt$/, "") +
        discoverParams;
    }
  }
...
export { getRecommendedNextLesson };
