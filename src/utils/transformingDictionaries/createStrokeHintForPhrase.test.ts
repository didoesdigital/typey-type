...
describe('create stroke hint for phrase', () => {
  ...
  describe('returns string showing all the space or slash separated strokes to write a whole phrase', () => {
    ...
    it('showing "*EU/TP*P/A*/R*/PH*/*E/R*" for "iFarmer"', () => {
      ...
      expect(createStrokeHintForPhrase(wordOrPhraseMaterial, globalLookupDictionary)).toEqual("*EU/KPA*/TPAR/PHER");
    ...
    it('show hints for first 12 words of longer phrase with different splits before stopping at stroke limit', () => {
      let wordOrPhraseMaterial = "one—two,3 4-5\"6'7:eight;nine.ten®eleven?twelve!thirteen+fourteen";
     ...
     expect(createStrokeHintForPhrase(wordOrPhraseMaterial, globalLookupDictionary)).toEqual("WUPB/EPL/TKA*RB/TWO/KW-BG/#P-/#H/H-PB/#A/KR-GS/#F/AE/#-P/KHR-PB/*E/*EU/TKPW*/H*/T*/STPH*FPLT/TPH*");
    ...
    it('with preceding exclamation mark and unknown word', () => {
      ...
      // expect(createStrokeHintForPhrase(wordOrPhraseMaterial, globalLookupDictionary)).toEqual("SKHRAPL/TP*/O*/O*");
      expect(createStrokeHintForPhrase(wordOrPhraseMaterial, globalLookupDictionary)).toEqual("SKHRAPL/TP*/KWRO/KWRO");
    });
    ...
    it('with and unknown word and trailing exclamation mark', () => {
      ...
      // expect(createStrokeHintForPhrase(wordOrPhraseMaterial, globalLookupDictionary)).toEqual("TP*/O*/O*/SKHRAPL");
      expect(createStrokeHintForPhrase(wordOrPhraseMaterial, globalLookupDictionary)).toEqual("TP*/KWRO/KWRO/SKHRAPL");
    });
    ...
    it('with prefix that is also a word that has trailing hyphen and a fake word', () => {
      ...
      expect(createStrokeHintForPhrase(wordOrPhraseMaterial, globalLookupDictionary)).toEqual("KWAS/KWREU/KAUPB/TP*/*U/STKPW*/STKPW*/HR*/-D");
    });
    ...
    it('with prefix that is not a word that has trailing hyphen and a fake word', () => {
      ...
      expect(createStrokeHintForPhrase(wordOrPhraseMaterial, globalLookupDictionary)).toEqual("TKPWHRAOEU/KAUPB/TP*/*U/STKPW*/STKPW*/HR*/-D");
    });
    ...
    it('with only a suffix, not showing a suffix outline but instead treating it as a word', () => {
      let wordOrPhraseMaterial = "ectomy";
      expect(createStrokeHintForPhrase(wordOrPhraseMaterial, globalLookupDictionary)).toEqual("EBGT/SKWRO/PHEU");
    });

    it("with mid^ prefix without a hyphen", () => {
      let wordOrPhraseMaterial = "mid^";
      expect(createStrokeHintForPhrase(wordOrPhraseMaterial, globalLookupDictionary)).toEqual("PHEUD");
    });

    it("with mid-^ prefix with hyphen", () => {
      const midDashPrefixPersonalDictionaries: PersonalDictionaryNameAndContents[] = []
      const midDashPrefixGlobalLookupDictionary = createAGlobalLookupDictionary(midDashPrefixPersonalDictionaries, {"PHEUD/H-PB": "{mid-^}"}, {});
      const wordOrPhraseMaterial = "mid-^";
      expect(createStrokeHintForPhrase(wordOrPhraseMaterial, midDashPrefixGlobalLookupDictionary)).toEqual("PHEUD/H-PB");
    });
    ...
    it('with random, hyphenated gibberish', () => {
      ...
      expect(createStrokeHintForPhrase(wordOrPhraseMaterial, globalLookupDictionary)).toEqual("TK*/KR*/K*/KP*/H-PB/TK*/KR*/K*/KP*");
    });
    ...
    it('with word, full stop, closing double quote, space, and capital letter', () => {
      ...
      expect(createStrokeHintForPhrase(wordOrPhraseMaterial, globalLookupDictionary)).toEqual("KAT/TP-PL/KR-GS/KPA/U");
    });
  ...
  describe('returns string showing text with spaced punctuation', () => {
    it('common punctuation', () => {
      ...
      let wordOrPhraseMaterial = "! # $ % & , . : ; = ? @";
      expect(createStrokeHintForPhrase(wordOrPhraseMaterial, globalLookupDictionary)).toEqual("SKHRAPL/HAERB/TPHRORB/P*ERS/SKP*/KW-BG/TP-PL/STPH-FPLT/STPH*FPLT/KW-L/H-F/SKWRAT");
    });
  ...
  describe('returns string containing top-level domain', () => {
    ...
    xit('shows fingerspelled outline for non-affixy ".com"', () => {
      let wordOrPhraseMaterial = ".com";
      expect(createStrokeHintForPhrase(wordOrPhraseMaterial, globalLookupDictionary)).toEqual("TP-PL/KR*/O*/PH*");
  ...
  describe('returns string showing text with numbers', () => {
    ...
    it('zero to ten with spaces', () => {
      ...
      expect(createStrokeHintForPhrase(wordOrPhraseMaterial, globalLookupDictionary)).toEqual("0EU/0EU/#S/#T/#P/#H/R5/#F/#-P/#L/#-T/1/0");
    });
  ...
  describe('returns hints for complex hyphenated phrases', () => {
    ...
    it('showing good stroke hint for hyphenated compound word with trailing punctuation', () => {
      ...
      expect(createStrokeHintForPhrase(wordOrPhraseMaterial, mouseHunterGlobalLookupDictionary)).toEqual("PHOUS/H-PB/HUPB/TER/KW-BG");
    });
    ...
    it('showing good stroke hint for capitalised, hyphenated compound word with trailing punctuation', () => {
      ...
      expect(createStrokeHintForPhrase(wordOrPhraseMaterial, globalLookupDictionary)).toEqual("KPA/HE/H-PB/HE/SKHRAPL");
    });

    it('showing good stroke hint for another hyphenated compound word with trailing punctuation', () => {
      const emptyPersonalDictionaries: PersonalDictionaryNameAndContents[] = [];
      const toHyphenDayCommaGlobalLookupDictionary = createAGlobalLookupDictionary(
        emptyPersonalDictionaries,
        {
          "H-PB": "{^-^}",
          "KW-BG": "{,}",
      ...
      expect(createStrokeHintForPhrase(wordOrPhraseMaterial, toHyphenDayCommaGlobalLookupDictionary)).toEqual("TO/H-PB/TPHAOEUT/KW-BG");
    });
    ...
    it('showing good stroke hint for another hyphenated compound word with suffix with hyphen and trailing punctuation', () => {
      ...
      expect(createStrokeHintForPhrase(wordOrPhraseMaterial, toHyphenDayCommaGlobalLookupDictionary)).toEqual("TO/TKA*EU/KW-BG");
    });
  });
  ...
  describe('returns hints for complex capitalised and punctuated phrases', () => {
    ...
    xit('showing good stroke hint for known word with added capital letter, punctuation, and internal apostrophe', () => {
      ...
      expect(createStrokeHintForPhrase(wordOrPhraseMaterial, globalLookupDictionary)).toEqual("KW-GS/KPA*/THER");
    ...
    it('showing good stroke hint for known word with added capital letter, punctuation, and internal apostrophe', () => {
      ...
      expect(createStrokeHintForPhrase(wordOrPhraseMaterial, globalLookupDictionary)).toEqual("KW-GS/KPA*/T-S");
    });
  ...
  describe('hints for personal phrasing briefs', () => {
    it("returns shorter outline for \"it can't\"", () => {
      const emptyPersonalDictionaries: PersonalDictionaryNameAndContents[] = [["phrasing-briefs.json", { "KPWH-BGT": "it can't", "KPWHO": "it can't", }]]
      const phrasingBriefGlobalLookupDictionary = createAGlobalLookupDictionary(emptyPersonalDictionaries, {}, {});
      const wordOrPhraseMaterial = "it can't";
      expect(createStrokeHintForPhrase(wordOrPhraseMaterial, phrasingBriefGlobalLookupDictionary)).toEqual("KPWHO");
    });
  });
  ...
  describe('returns hints for phrasing briefs prioritising phrasing brief starters', () => {
    ...
    xit('returns T*D for "it\'d" instead of EUTD', () => {
      ...
      expect(createStrokeHintForPhrase(
        wordOrPhraseMaterial,
        createAGlobalLookupDictionary(
          emptyPersonalDictionaries,
          {
  ...
  describe('returns hints for complex case with stars, slashes, suffixes, misused suffixes, and outlines ending in S and Z', () => {
    it("returns HOR/TKEFRBZ for hors d'oeuvres", () => {
      ...
      expect(createStrokeHintForPhrase(wordOrPhraseMaterial, globalLookupDictionary)).toEqual("HOR/TKEFRBZ");
    });
  });
